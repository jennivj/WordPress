  ...
  <div id="admin-top" style="padding-bottom:5px; padding-left:5px;">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr class="td">
        ...
        <td width="203" class="td-widht"><label class="submit">
   ...
   <!-- <table width="100%" cellspacing="0" class="widefat" <?php //if($searchText=='' && $tot_cnt>1 && $sort=='faq_ordering') { ?> id="table-1" <?php //} ?>>-->
      ...
      <thead>
        ...
        <tr class="nodrag nodrop">
          ...
          <th width="357" class="<?php echo $field_sort.' '.$class_sort; ?>">
          ...
          <th width="325" class="<?php echo $field_sort.' '.$class_sort; ?>">
          ...
          <th width="195" align="right" style="text-align:right; padding-right:30px;">
      ...
      <tbody>
        ...
        <tr id="<?php echo $rec_list[$i]->$primary_key; ?>">
          ...
          <td width="71" align="left" style="padding-left:25px;"><?php echo $cnt;?></td>
		 ...
		 ?>          </td>
		  ...
		  <td width="260"><?php echo ($rec_list[$i]->status=='N')?'Inactive':'Active'; ?></td>

          <td width="111"><a href="<?php echo get_option('siteurl').'/wp-admin/admin.php?page='.$page_name.'&'.$primary_key.'='.$rec_list[$i]->$primary_key;?>&option=add"  title="Edit this record">Edit</a></td>

          <td width="195" align="right" style="padding-right:32px;"><input type="checkbox" name="del" value="<?php echo $rec_list[$i]->$primary_key;?>" style="cursor:default" /></td>
