  ...
  <form enctype="multipart/form-data" name="add" id="add" method="post" action="<?php echo $_SERVER['REQUEST_URI'].'&option=add'; ?>" onsubmit="return validate();">
    <table cellspacing="0" class="widefat" >
      ...
      <tbody>
        <tr align="left">
        <tr align="left">
          <td width="9%">Question<span style=" color:#F00;">*</span></td>
          <td width="81%" align="left"><input type="text" id="faq_question" title="Question" value="<?php echo $question;?>" size="90" name="faq_question"  onkeypress="if(event.keyCode=='13') return validate();"/></td>
          <td width="10%">&nbsp;</td>
        </tr>
		
		    
        <tr align="left">
          <td width="9%"  valign="middle">Answer<span style=" color:#F00;">*</span></td>
		...
		<tr align="left">
          <td width="9%"  valign="middle">Status<span style=" color:#F00;">*</span></td>
          <td colspan="2" align="left">
